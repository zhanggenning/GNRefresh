...
@interface TDRefreshStateHeader ()
{
    /** 显示上一次刷新时间的label */
...
@implementation TDRefreshStateHeader
#pragma mark - 懒加载
...
- (void)prepare
{
    ...
    // 初始化文字
    [self setTitle:TDRefreshHeaderIdleText forState:TDRefreshStateIdle];
    [self setTitle:TDRefreshHeaderPullingText forState:TDRefreshStatePulling];
    [self setTitle:TDRefreshHeaderRefreshingText forState:TDRefreshStateRefreshing];
}
