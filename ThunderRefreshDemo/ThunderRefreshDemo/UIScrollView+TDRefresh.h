...
@class TDRefreshHeader, TDRefreshFooter;

@interface UIScrollView (TDRefresh)

/** 下拉刷新控件 */
@property (strong, nonatomic) TDRefreshHeader *header;

/** 上拉刷新控件 */
@property (strong, nonatomic) TDRefreshFooter *footer;
 ...
 *  是否已经添加下拉刷新
 */
@property (nonatomic, assign) BOOL headerIsAdded;
 ...
 *  是否已添加上拉刷新
 */
@property (nonatomic, assign) BOOL footerIsAdded;
